...
//            throw new HttpRequestException($"HTTP Hata Kodu: {response.StatusCode}, Ýçerik: {responseAsString}");

//        return JsonSerializer.Deserialize<TResponse>(responseAsString, _options)
//            ?? throw new Exception("Yanýt deserialization sýrasýnda null döndü!");
//    }
